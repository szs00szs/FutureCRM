...
<body>
 ...
 <div align="right">
 	<a href="${pageContext.request.contextPath }/customer/customer_update/${customer.id}/${currentPage}">编辑</a>
 	<br>
 	<a href="${pageContext.request.contextPath }/customer/customer_list/1">返回客户列表</a>
 </div>
</body>
</html>